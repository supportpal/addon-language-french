...
return array(
    ...
    "public"                    => "Public",
    "public_desc"               => "Si le champ personnalisé est visible au public ou si c'est seulement pour le staff.",
    "encrypted"                 => "Chiffré",
    "purge_desc"                => "Si le champ personnalisé doit être supprimé dès que le ticket est résolu.",
    "locked"                    => "Verrouillé",
    "locked_desc"               => "Si le champ personnalisé ne peut pas être modifié par un utilisateur une fois enregistré.",
     ...
     * 2.0.3
     */
    "description_desc"          => "Le texte d'aide apparaissant sous le champ personnalisé. Ce champ peut rester vide.",
    ...
    "regex_basic_desc"          => "Veuillez spécifier une expression régulière pour valider le champ personnalisé (optionnel).",
    ...
    "custom_field_values"       => "Valeurs des champs personnalisés",
    ...
    "purge"                     => "Purge",
    "encrypted_desc"            => "Si la valeur du champ personnalisé est sensible et devrait être sauvegardée chiffrée dans la base de donneés. Cette information ne peut plus être changée une fois le champ créé.",

    /*
     * 2.3.1
     */
    "required_desc"             => "Si le champ personnalisé est obligatoire. Pour les checkbox, checklist, le fait d'en cocher une minimum sera requis.",
